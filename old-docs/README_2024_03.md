...
5. For SSL Unpinning we will install [LSPosed](https://github.com/LSPosed/LSPosed) in Magisk.
   ...
   3. [JingMatrix/LSPosed](https://github.com/JingMatrix/LSPosed). Note: updated in 2025 to use [a community recommended upto date fork](https://xdaforums.com/t/what-version-of-xposed-should-i-install-or-are-they-all-dead.4716584/).
